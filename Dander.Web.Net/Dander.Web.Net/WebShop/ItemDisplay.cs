...
{
    [ToolboxData( "<{0}:ItemDisplay runat=\"server\" />" )]
    public class ItemDisplay : WebControl
    {
        public ItemDisplay() : base( HtmlTextWriterTag.Div )
        {
        ...
        public interface IApiController
        {
            ...
            /// <returns></returns>
            [HttpGet]
            SelectItemsResponse SelectItems(string filter, int page = 1, int pageCapacity = 10);
            ...
            /// <returns></returns>
            [HttpGet]
            GetItemContentResponse GetItemContent(string itemRef);
        }
        ...
        {
            set { base.CssClass = "danderweb item-display" + (value.Length > 0 ? " " + value : ""); }
        }
        protected override string TagName
        {
            get { return "Web Shop Item Display"; }
        }
    }
}
